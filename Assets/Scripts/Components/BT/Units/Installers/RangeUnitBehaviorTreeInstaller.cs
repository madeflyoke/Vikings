...
{
    public class RangeUnitBehaviorTreeInstaller : IBehaviorTreeInstaller //used in config
    {
        ...
        public void Install(BehaviorTree behaviorTree, IBehaviorTreeInstallerData behaviorTreeInstallerData)
        {
            ...
            if (behaviorTreeInstallerData is not RangeUnitBehaviorTreeInstallerData installerData)
            {
